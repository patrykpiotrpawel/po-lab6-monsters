...
namespace Catch {
    ...
    public: // operators
        auto operator==(StringRef other) const
...
namespace Catch {
    ...
    struct SourceLineInfo {
        ...
        constexpr SourceLineInfo(char const *_file, std::size_t _line)
...
#pragma optimize("", on)
        ...
        inline auto invoke_deoptimized(Fn &&fn, Args &&... args) -> std::enable_if_t<!std::is_same<void, decltype(
                fn(args...))>::value> {
...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            ...
            template<typename Clock, typename Fun>
            using run_for_at_least_argument_t = std::conditional_t<is_callable<Fun(
                    Chronometer)>::value, Chronometer, int>;
...
namespace Catch {
    ...
    namespace Detail {
        ...
        constexpr StringRef
        unprintableString = "{?}"_sr;

        //! Encases `string in quotes, and optionally escapes invisibles
        std::string convertIntoString(StringRef
        string,
...
#endif
return
std::string(timeStamp, timeStampSize
- 1);
}
};
}
...
namespace Catch {
    ...
    namespace Detail {
        ...
        std::vector <std::string> splitReporterSpec(StringRef
        reporterSpec );

        Optional<ColourMode> stringToColourMode(StringRef
        colourMode );
    }
...
namespace Catch {
    ...
    std::vector <TestCaseHandle> filterTests(std::vector < TestCaseHandle >
    const& testCases,
...
namespace Catch {
    ...
    namespace Generators {
        ...
        table( std::initializer_list<std::tuple < std::decay_t < Ts>
        ...>> tuples ) {
    ...
    tracker.
    setGenerator(Catch::Detail::make_unique<Generators < UnderlyingType>>
    (
...
template<typename T>
constexpr bool empty(std::initializer_list <T> list)
...
namespace Catch {
    ...
    namespace Detail {
        ...
        Catch::Detail::unique_ptr<EnumInfo> makeEnumInfo(StringRef
        enumName,
        ...
        std::vector<StringRef> parseEnums(StringRef
        enums );
...
namespace Catch {
    ...
    public:
        TestInvokerAsFunction(TestType testAsFunction)
...
namespace Catch {
    namespace Matchers {
        ...
        namespace Detail {
            ...
            //! not be trying to compose stored composition matchers
            template<typename ArgT>
            MatchAllOf<ArgT> operator&&(MatcherBase < ArgT >
            const& lhs,
...
namespace Catch {
    namespace Matchers {
        ...
        namespace Detail {
            ...
            struct conjunction<Cond, Rest...> : std::integral_constant<bool,
                    Cond::value && conjunction<Rest...>::value> {
            };
            ...
            bool
            match_all_of(Arg &&arg, std::array<void const *, N> const &matchers, std::index_sequence<Idx, Indices...>) {
            ...
            template<typename T, typename... MatcherTs, std::size_t N, typename Arg, std::size_t Idx, std::size_t... Indices>
            bool
            match_any_of(Arg &&arg, std::array<void const *, N> const &matchers, std::index_sequence<Idx, Indices...>) {
                return static_cast<T const *>(matchers[Idx])->match(arg) ||
            ...
            combine,
            std::string const *descriptions_begin, std::string
            const* descriptions_end);

            template<typename... MatcherTs, std::size_t... Idx>
            std::string describe_multi_matcher(StringRef
            combine,
            std::array<void const *, sizeof...(MatcherTs)> const &matchers, std::index_sequence<Idx...>
            ) {
            ...
            return
            describe_multi_matcher(combine, descriptions
            .
        ...
        public:
            ...
            explicit MatchAllOfGeneric(std::array<void const *, sizeof...(MatcherTs)> matchers) : m_matchers{
                    matchers} {}
            ...
            MatchAllOfGeneric<MatcherTs..., MatchersRHS...> operator&&(
                ...
                return MatchAllOfGeneric<MatcherTs..., MatchersRHS...>{array_cat(CATCH_MOVE(lhs.m_matchers),
            ...
            friend std::enable_if_t<is_matcher<MatcherRHS>::value,
                ...
                return MatchAllOfGeneric<MatcherTs..., MatcherRHS>{array_cat(CATCH_MOVE(lhs.m_matchers),
        ...
        public:
            ...
            explicit MatchAnyOfGeneric(std::array<void const *, sizeof...(MatcherTs)> matchers) : m_matchers{
                    matchers} {}
            ...
            friend MatchAnyOfGeneric<MatcherTs..., MatchersRHS...> operator||(
                ...
                return MatchAnyOfGeneric<MatcherTs..., MatchersRHS...>{array_cat(CATCH_MOVE(lhs.m_matchers),
                                                                       CATCH_MOVE(rhs.m_matchers))};
            }
            ...
            friend std::enable_if_t<is_matcher<MatcherRHS>::value,
                    ...
                    MatchAnyOfGeneric<MatcherTs...> &&lhs,
                    MatcherRHS const &rhs) {
                return MatchAnyOfGeneric<MatcherTs..., MatcherRHS>{array_cat(CATCH_MOVE(lhs.m_matchers),
    ...
    std::enable_if_t<Detail::is_generic_matcher<MatcherLHS>::value, Detail::MatchAllOfGeneric<MatcherLHS,
            MatcherBase < ArgRHS>>>
    operator&& (MatcherLHS
    const& lhs,
    MatcherBase <ArgRHS> const &rhs
    ) {
    return {
    lhs, rhs
};
...
std::enable_if_t <Detail::is_generic_matcher<MatcherRHS>::value, Detail::MatchAllOfGeneric<
        MatcherBase < ArgLHS>, MatcherRHS>>
operator&& (MatcherBase<ArgLHS>
const& lhs,
MatcherRHS const &rhs
) {
return {
...
template<typename MatcherLHS, typename ArgRHS>
std::enable_if_t <Detail::is_generic_matcher<MatcherLHS>::value, Detail::MatchAnyOfGeneric<MatcherLHS,
        MatcherBase < ArgRHS>>>
operator|| (MatcherLHS
const& lhs,
MatcherBase <ArgRHS> const &rhs
...
template<typename ArgLHS, typename MatcherRHS>
std::enable_if_t <Detail::is_generic_matcher<MatcherRHS>::value, Detail::MatchAnyOfGeneric<
        MatcherBase < ArgLHS>, MatcherRHS>>
operator|| (MatcherBase<ArgLHS>
const& lhs,
MatcherRHS const &rhs
...
namespace Catch {
    namespace Matchers {
        ...
        ContainsSubstring(std::string const &str, CaseSensitive caseSensitivity = CaseSensitive::Yes);
